<template>
    <footer class="text-white  mt-28   ">
        <div id="wave" class="-mb-1  ">
        ...
        <div class="mycontainer p-4 pt-12   ">
            ...
            <div class="wrapper mx-auto w-11/12 justify-items-center    ">
                ...
                <div class="slogan">
                    <div>
                        <img src="../assets/clean.webp" alt="clean services" />
                    </div>
                    <h2>
                        شركة هَانِي كلِين للتنظيف <br>
                        خدمات تنظيف عالية الجودة للمنازل والشركات
                    </h2>
                </div>
                <div class="foot">
                    <p dir="rtl"> hani.clean للتنظيف &copy; 2023</p>
...
.slogan>div:nth-of-type(1)::after {
    content: "";
    position: absolute;
    width: 30px;
    height: 30px;
